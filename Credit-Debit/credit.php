...
if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['submit'])){
	...
	$keepQuery = $db->prepare("INSERT INTO credit (cus_id, balance, amount, creditdate) VALUES (:cid, :bal, :amt, :cdate)");
	$keepQuery->execute(
		[
			'cid' => $_SESSION['id'],
			'bal' => $bal,
			...
			<div class="row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul class="list-group">
								<li class="list-group-item disabled"><a href="#" >Deposit / Credit</a></li>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading"><h4>Deposit / Credit</h4></div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
							    ...
							    <div class="col-md-6">
							        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
							            <div class="form-group">
							                <label for="credit">Enter credit amount</label><span style="color:red"> * <?php  ?></span>
							                <input type="number" class="form-control" value="<?php echo isset($_POST['credit']) ? $_POST['credit'] : ''; ?>" name="credit" placeholder="Enter amount to deposit" autocomplete="off" required>
							            </div>
